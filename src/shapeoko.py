...
from math import *
import getopt
from shapeoko.context import GCodeContext
from shapeoko.svg_parser import SvgParser
...
class MyEffect(inkex.Effect):
  def __init__(self):
    ...
    self.OptionParser.add_option("--start-delay",
                      ...
                      dest="start_delay", default="0.1",
                      help="Delay after pen down command before movement in s")
    self.OptionParser.add_option("--stop-delay",
                      action="store", type="float",
                      dest="stop_delay", default="0.1",
                      help="Delay after pen up command before movement in s")
    ...
    self.OptionParser.add_option("--finished-height",
                      action="store", type="float",
                      dest="finished_height", default="5.0",
